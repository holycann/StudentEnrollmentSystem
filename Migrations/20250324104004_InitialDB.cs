        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReceiveSecurityNotifications = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    LoginAlertEmails = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ...
                    PaymentReminders = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CourseUpdates = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnrollmentNotifications = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RememberBrowser = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrerequisiteCoursesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseCourse", x => new { x.CourseId, x.PrerequisiteCoursesId });
                    table.ForeignKey(
                        name: "FK_CourseCourse_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseCourse_Courses_PrerequisiteCoursesId",
                        column: x => x.PrerequisiteCoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TeachingEffectiveness = table.Column<int>(type: "int", nullable: false),
                    CourseContent = table.Column<int>(type: "int", nullable: false),
                    LearningMaterials = table.Column<int>(type: "int", nullable: false),
                    ...
                    TechnologyUse = table.Column<int>(type: "int", nullable: false),
                    Strengths = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AreasForImprovement = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AdditionalComments = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeachingEvaluations_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseCourse_PrerequisiteCoursesId",
                table: "CourseCourse",
                column: "PrerequisiteCoursesId");
